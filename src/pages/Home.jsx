...
export const Home = () => {
  ...
  return (
    <div className="bg-brand-cream min-h-screen">
      ...
      <section className="bg-brand-maroon text-amber-100 py-8 border-b border-amber-900/60">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-2 md:grid-cols-5 gap-6 text-center text-xs">
            <div className="flex flex-col items-center space-y-1.5">
              <Award className="w-6 h-6 text-brand-gold" />
              <span className="font-serif font-bold text-brand-gold">Authentic Handloom</span>
            </div>
            <div className="flex flex-col items-center space-y-1.5">
              <ShieldCheck className="w-6 h-6 text-brand-gold" />
              <span className="font-serif font-bold text-brand-gold">Premium Silk Mark</span>
            </div>
            <div className="flex flex-col items-center space-y-1.5">
              <Sparkles className="w-6 h-6 text-brand-gold" />
              <span className="font-serif font-bold text-brand-gold">Zari Craftsmanship</span>
            </div>
            <div className="flex flex-col items-center space-y-1.5">
              <ShieldCheck className="w-6 h-6 text-brand-gold" />
              <span className="font-serif font-bold text-brand-gold">Secure Shopping</span>
            </div>
            <div className="col-span-2 sm:col-span-1 flex flex-col items-center space-y-1.5">
              <Truck className="w-6 h-6 text-brand-gold" />
              <span className="font-serif font-bold text-brand-gold">Pan-India Delivery</span>
            </div>
          </div>
        </div>
      </section>

      {/* 3. OUR COLLECTION GRID */}
      ...
      {/* 6. VISIT US IN YEOLA (GOOGLE MAPS SECTION) */}
      <YeolaMap />
